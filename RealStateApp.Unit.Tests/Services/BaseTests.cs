...
public class BaseTests 
{
    ...
    public async Task DeleteAsync_Should_Delete_SaleType_And_Properties_With_That_Type()
    {
        ...
        // Me acabo de dar cuenta que DB en memoria no soporta los metodo ExecuteOnDeleteAsync. No puedo hacer nada al respecto
        ...
        var result = await service.AddAsync(dto);
        // Act
        var deleteResult = await service.DeleteAsync(result.Value!.Id);
