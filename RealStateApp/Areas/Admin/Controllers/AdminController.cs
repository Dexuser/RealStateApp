...
public class AdminController : Controller
{
    ...
    public async Task<IActionResult> CreateAdmin(CreateAdminViewModel model)
    {
        ...
        var createResult = await _adminService.CreateAdmin(userSave, origin);
    ...
    public async Task<IActionResult> EditAdmin(EditAdminViewModel model)
    {
        ...
        var userSave = _mapper.Map<UserSaveDto>(model);
        var origin = HttpContext.Request.Headers.Origin.FirstOrDefault() ?? "";
        await _adminService.EditAdmin(userSave, origin);
        return RedirectToAction(nameof(Index));
    }
    ...
    {
        var stateResult = await _adminService.SetStatusOnAdminAsync(model.UserId, model.State);
    ...
    {
        await _adminService.DeleteAdminAsync(model.UserId);
        return RedirectToAction(nameof(Index));
    }
}